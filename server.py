...
def api_beautify():  
    ...
    url = "https://techhk.aoscdn.com/api/tasks/beautify/portrait"  # <— periksa dan sesuaikan jika berubah  
...
def api_background():  
    ...
    url = "https://techhk.aoscdn.com/api/tasks/visual/segmentation"  # <— periksa dan sesuaikan  
    headers = {"X-API-KEY": PICWISH_API_KEY}  
    files = {"image_file": open(img_path, "rb")}  
    response = requests.post(url, headers=headers, files=files)  
...
def api_style():  
    ...
    url = "https://techhk.aoscdn.com/api/tasks/ai-enhance"  # <— periksa dan sesuaikan  
    headers = {"X-API-KEY": PICWISH_API_KEY}  
    files = {"image_file": open(img_path, "rb")}  
    response = requests.post(url, headers=headers, files=files)  
